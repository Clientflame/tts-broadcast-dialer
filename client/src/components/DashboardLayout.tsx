...
const adminMenuItems = [
  ...
  { icon: Shield, label: "Security Logs", path: "/security-logs" },
  ...
  { icon: Shield, label: "Carrier Health", path: "/carrier-health" },
  ...
  return (
    <>
      ...
      <SidebarInset>
        ...
        <main className="flex-1 p-3 sm:p-4 pb-20 md:pb-4">{children}</main>
      </SidebarInset>
    </>
  );
}
